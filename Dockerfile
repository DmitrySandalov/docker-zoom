...
RUN apt-get -y install \
    ...
    libgstreamer-plugins-base0.10-0 libgstreamer0.10-0 libice6 libllvm3.4 \
...
RUN curl -L https://oracle.zoom.us/client/latest/zoom_1.1.37479.0107_amd64.deb > /tmp/zoom.deb
